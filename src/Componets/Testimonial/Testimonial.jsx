...
const Testimonial = () => {
    ...
    return (
        <div  data-aos="flip-left" className="my-2">
            <div>
                <h2 className="text-3xl text-center font-semibold mt-3">Our Client says,</h2>
                <p className="text-center">Some Testimonial from our Clients</p>
            </div>
